package aulas_lucena.projetoFinal.ui.util;
...
public class Imagens {
    ...
    public static ImageIcon iconeCadastroPokemon(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconePikachu.png",
            larg, altu
        );
    }
    public static ImageIcon iconeCadastroPokemonSelecionado(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconePikachuSelecionado.png",
            larg, altu
        );
    }
    ...
    public static ImageIcon iconeCadastroJogo(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconeJogos.png",
            larg, altu
        );
    }
    public static ImageIcon iconeCadastroJogoSelecionado(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconeJogosSelecionada.png",
            larg, altu
        );
    }
    ...
    public static ImageIcon iconeCadastroRegiao(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconeMapa.png",
            larg, altu
        );
    }
    public static ImageIcon iconeCadastroRegiaoSelecionado(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconeMapaSelecioando.png",
            larg, altu
        );
    }
    ...
    public static ImageIcon iconeCadastroElemento(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconeElemento.png",
            larg, altu
        );
    }
    public static ImageIcon iconeCadastroElementoSelecionado(int larg, int altu) {
        return getImagemIcone(
            "/aulas_lucena/projetoFinal/conteudos/imgs/comuns/iconeElementoSelecionado.png",
            larg, altu
        );
    }
}
