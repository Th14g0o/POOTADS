...
Para isso aperte ```ctrl + shift + p``` e digite "Java: Configure Classpath" clique na opção e o VSCode abrira uma tela com abas para configurar o projeto java. Na aba libraries adicione o jar localizado nas pasta lib do projeto final(```.\projetoFinal\lib\sqlite-jdbc-3.51.1.0.jar```)
