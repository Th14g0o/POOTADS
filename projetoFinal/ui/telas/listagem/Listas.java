...
public class Listas extends JPanel  {;
    ...
    public Listas() {
        ...
        painelConteudo.add(new ListagemJogo(), "LISTAGEM_JOGO");
        painelConteudo.add(new ListagemRegiao(), "LISTAGEM_REGIAO");
        painelConteudo.add(new ListagemPokemon(), "LISTAGEM_POKEMON");
        painelConteudo.add(new ListagemElemento(), "LISTAGEM_ELEMENTO");
